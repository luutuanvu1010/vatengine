...
| Gói 2 — bảng `goi_chia_se` + migration | ✅ DONE (code) — ⏸ CHỜ ÁP MIGRATION | `3bd87f4` | 8 test xanh. Bẫy `_journal.json` NỔ đúng dự đoán: 0020.when sinh ra là 29/07 < 0019 (02/08) ⇒ đã đặt lại `0019.when + 60000`. **Cổng dừng 1**: chủ dự án chạy `make migrate`, rồi hậu kiểm `node scripts/hau-kiem-bang.mjs goi_chia_se` |
