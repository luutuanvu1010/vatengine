...
> Trạng thái: **🟢 PRODUCTION LIVE — đã deploy U17+U29 (2026-07-19).** Site chạy tại `https://vatengine.tourdao.vn` (same-origin, **phiên bằng cookie HttpOnly**, đủ 4 security header). Còn treo: HSTS+WAF tầng zone (Bước 5), onboarding tenant tự phục vụ (O1), verify đồng bộ HĐ thật (cần token GDT + captcha của chủ dự án).
>
