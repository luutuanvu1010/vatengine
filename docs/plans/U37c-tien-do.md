...
| **Gói 4 — bucket riêng tư** | ⛔ **TREO — cổng dừng 2 chặn** | — | Đo trước khi gỡ: **có 1 gói `san_sang` đang dùng**. Kế hoạch quy định gặp ca này thì DỪNG và hỏi chủ dự án. Gỡ custom domain lúc này sẽ giết liên kết đang lưu hành |
...
### Cổng dừng Gói 4 — ⛔ CHẶN

Phân bố lúc đo: `san_sang` 1 · `dang_tao` 1 · `da_thu_hoi` 2. Còn gói đang phát hành ⇒
không gỡ custom domain. Chờ chủ dự án quyết: thu hồi gói đó trước, hay đợi nó hết hạn.
