...
- **Trạng thái:** ✅ **Đã lên kế hoạch → xem `docs/plans/U22-plan.md`** (phiên Cowork 2026-07-16). Quyết định phạm vi đã chốt: tự lấy TOÀN BỘ khoảng lọc, thanh tiến độ theo tháng, tự áp lại bộ lọc khi xong. Chưa hiện thực code.
