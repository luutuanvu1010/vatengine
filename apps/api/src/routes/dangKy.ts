...
// MST 10, 12, 13 chữ số, hoặc dạng "10 số-3 số" (giá trị verbatim — không đổi dạng, kể cả
// dấu gạch ngang: gõ sao lưu vậy, gửi GDT y nguyên).
// 10 = doanh nghiệp/tổ chức; 13 (liền) hoặc 10-3 (gạch ngang) = đơn vị phụ thuộc/chi nhánh
// — hai cách viết của cùng một khái niệm, đều phải nhận; 12 = số định danh cá nhân (CCCD)
// dùng thay MST cho cá nhân & hộ kinh doanh theo Thông tư 86/2024/TT-BTC (từ 01/07/2025).
