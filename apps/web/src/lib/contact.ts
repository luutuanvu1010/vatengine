// Kênh liên hệ góp ý — một số dùng chung cho Zalo & gọi điện. Thông tin công khai chủ
// dự án tự nguyện đăng (KHÔNG phải bí mật hệ thống).
export const CONTACT_PHONE = "0989929373";
